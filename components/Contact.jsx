            ...
            <div className="col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4 ">
              <div className="lg:p-4 h-full">
                ...
                <div>
                   ...
                   <p className="py-4">I am always available for you. Contact me and let's talk.</p>
                </div>
                <div>
              <p className="uppercase pt-8">Connect With me</p>
              <div className="flex items-center justify-between py-4">
                
              <a href="https://www.instagram.com/_ujj_wal_/" target='_blank' rel="noopener noreferrer" >
              ...
              <a href="https://www.facebook.com/uzwal.duwal.1/" target='_blank' rel="noopener noreferrer" >
              <div className="rounded-full shadow-lg shadeo-gray-400 p-4 cursor-pointer hover:scale-105 ease-in duration-300">
            ...
            <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4">
                <div className="p-4">
                    <form>
                        ...
                        <button className="w-full p-4 text-gray-100 mt-4 rounded-lg hover:bg-gradient-to-l from-[#FFA726] to-[#FF7043]">Send Message</button>
                    </form>
                </div>
          ...
          <div className="flex justify-center py-12">
            <Link href='/#home'>
                <div className="rounded-full shadow-lg shadeo-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300">
                    <HiOutlineChevronDoubleUp className="text-[#FFA726]" size={30} />
                </div>
            </Link>
          </div>
        </div>
